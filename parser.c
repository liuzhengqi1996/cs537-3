        ...
        Node ** parser(char *path) {
            ...
            if(fp == NULL){
                ...
                for (int i = 0; i < BUFFSIZE; i++) {
                    ...
                    for(int j=0;j<BUFFSIZE;j++){s[i] -> command[j] = (char **) malloc(sizeof(char*) * 200);
                    }
                }
                ...
                printf("0:dep:%s\n",s[1] -> dependence[1]);
                printf("0:dep:%s\n",s[1] -> dependence[2]);
                printf("1-0-0:command,%s\n",s[1]-> command[0][0]);
                printf("1-0-1:command,%s\n",s[1]-> command[0][1]);
                printf("2-1-1:command,%s\n",s[2]-> command[1][1]);
                printf("2-2-2:command,%s\n",s[2]-> command[2][2]);
                printf("4-1-2:command,%s\n",s[4]-> command[1][2]);
                printf("1:dep:%s\n",s[2] -> dependence[0]);
